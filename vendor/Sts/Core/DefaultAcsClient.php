...
namespace Aliyun\Sts\Core;

use Aliyun\Sts\Core\Exception\ClientException;
use Aliyun\Sts\Core\Exception\ServerException;
use Aliyun\Sts\Core\Regions\EndpointProvider;
use Aliyun\Sts\Core\Http\HttpHelper;
